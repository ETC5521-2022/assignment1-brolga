...
```{r}
tibble(
  "variable" = colnames(ratings %in% c("id", "name", "average")),
...
```{r}
tibble(
  "variables" = colnames(details %in% c("id", "yearpublished", "boardgamemechanic")),
  "class" = c("double", "double", "character"),
...
Harmon, J. (2022). Tidy Tuesday. Retrieved from 
