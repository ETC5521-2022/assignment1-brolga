...
```{r}
tibble(
  "variables" = colnames(details %in% c("id", "yearpublished", "boardgamemechanic", "minplayers", "maxplayers", "playingtime", "owned", "trading", "wanting", "wishing")),
  "class" = c("double", "double", "character", "number", "number", "number", "number", "number", "number", "number"),
