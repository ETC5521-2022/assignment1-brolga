...
The Board Games data set come from [Kaggle](https://www.kaggle.com/jvanelteren/boardgamegeek-reviews/version/3?select=2022-01-08.csv) by way of [Board Games Geek](https://www.boardgamegeek.com/), with a hattip to [David and Georgios ](https://github.com/rfordatascience/tidytuesday/issues/382#issuecomment-1020305849).

This has a total of two data sets, **ratings** and **details**. The ratings data set size is around 4.8MB, contains 21,631 observations and 10 columns. The details data set size is approximately 32.7MB, contains 21,831 observations and 23 columns.

The [ratings](https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2022/2022-01-25/ratings.csv) data set contains information about the game, average rating , rank and theoretical rating average (bayes average). Every game's url and thumbnail link is also provided. It was collected over a time period of 100 AD to 2022.
...
The [details](https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2022/2022-01-25/details.csv) data set provides information about the type of board game, game mechanics, who was the artist, creator and publisher of the game. It provides an extensive detail about the game such as min and max player who can play the game, minimum age, how the game is played and also put each game in categories such as building, dice, drinking e.t.c. The data collected is over a time period of 400 AD to 2023.
...
For the playing time, I would expect as people have lesser leisure time, the game time should decrease to incorporate people's new lifestyles. For the rating, the average rating would be lower as there are more choice of games for people to play, which mean that there are more options for the people to compare the game. As for the game mechanics, people in different eras would have different preferred game types.

**Q4. Since the computer is more accessible, people are shifting to online games. How does this affect buyer behaviour?**

I would expect the number of people who owned board game to decrease around 2012 when a popular mobile game such as subway surfers, temple run was released. And in 2020, when COVID-19 hit, I expect the number of people who owned the game to decrease.
